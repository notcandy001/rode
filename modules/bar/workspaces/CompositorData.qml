...
Singleton {
    ...
    function updateWindowList() {
        // No-op: state is now pushed inline via rodctl subscribe events
    }
    ...
    Connections {
        target: RodctlService.clients

        function onValuesChanged() {
            root.windowList = RodctlService.clients.values
    ...
    Connections {
        ...
        function onValuesChanged() {
            root.monitors = RodctlService.monitors.values
        }
    }
}
