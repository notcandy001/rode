...
QtObject {
    ...
    function generate(Colors) {
        ...
        let css = `/**
 * @name Rode
 * @description A Discord recolor theme, generated with Rode.
 * @author rode
 * @version 1.0.0
 * @invite gHG9WHyNvH
 * @website https://github.com/notcandy/rode
 * @source https://github.com/Axenide/Rode
 * @authorId 294856304969908224
 * @authorLink https://github.com/notcandy
*/ 
...
`
        ...
        const vesktopPath = home + "/.config/vesktop/themes/rode.css"
