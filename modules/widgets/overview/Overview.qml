...
Item {
    ...
    readonly property var monitor: currentScreen ? RodctlService.monitorFor(currentScreen) : RodctlService.focusedMonitor
    ...
    function navigateToSelectedWindow() {
        ...
        Qt.callLater(() => {
            RodctlService.dispatch(`focuswindow address:${win.address}`);
        });
    }
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    if (overviewRoot.draggingTargetWorkspace === -1) {
                                        ...
                                        RodctlService.dispatch(`workspace ${workspaceValue}`);
                                    }
                                }
                                onDoubleClicked: {
                                    if (overviewRoot.draggingTargetWorkspace === -1) {
        ...
        Item {
            ...
            Repeater {
                ...
                delegate: OverviewWindow {
                    ...
                    onWindowClosed: {
                        RodctlService.dispatch(`closewindow address:${windowData.address}`);
                    }
                }
            }
