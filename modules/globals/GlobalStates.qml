...
Singleton {
    ...
    // Compositor config properties (RodctlService)
    ...
    function toggleAssistant() {
        if (assistantVisible) {
            ...
            if (RodctlService.focusedMonitor && RodctlService.focusedMonitor.name) {
                assistantScreenName = RodctlService.focusedMonitor.name;
