...
Item {
    ...
    readonly property bool hasFullscreenWindow: {
        const monitor = RodctlService.monitorFor(targetScreen);
        if (!monitor)
            return false;
        ...
        if (toplevel && toplevel.fullscreen && RodctlService.focusedMonitor.id === monId) {
            return true;
        }
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "rode:screenFrame:top"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "rode:screenFrame:bottom"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "rode:screenFrame:left"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "rode:screenFrame:right"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "rode:screenFrame:overlay"
