...
if nix profile list | grep -q "Rode"; then
  log_info "Updating Rode..."
  nix profile upgrade Rode --refresh --impure
else
  log_info "Installing Rode..."
...
migrate_old_paths() {
log_info “Checking for old Rode paths…”

# Source migration (PascalCase -> lowercase)

local OLD_SRC=”$HOME/Rode”
...
local OLD_CONFIG=”$HOME/.config/Rode”
local NEW_CONFIG=”$HOME/.config/rode”
...
local OLD_SHARE=”$HOME/.local/share/Rode”
local NEW_SHARE=”$HOME/.local/share/rode”
...
local OLD_STATE=”$HOME/.local/state/Rode”
local NEW_STATE=”$HOME/.local/state/rode”
...
local OLD_CACHE_DIR=”$HOME/.cache/Rode”
local NEW_CACHE_DIR=”$HOME/.cache/rode”
...
local NEW_CACHE=”$HOME/.cache/rode”
if [[ -d “$NEW_SHARE” ]]; then
mkdir -p “$NEW_CACHE”
...
log_info “Rode now uses a multi-file configuration in $NEW_CONFIG/config/”
...
log_info “Cloning Rode to $INSTALL_PATH…”
mkdir -p “$(dirname “$INSTALL_PATH”)”
...
curl -fsSL https://raw.githubusercontent.com/notcandy001/rodctl/refs/heads/main/install.sh | bash
...
[[ -f “$HOME/.local/bin/rode” ]] && rm -f “$HOME/.local/bin/rode”

sudo mkdir -p “$BIN_DIR”
local LAUNCHER=”$BIN_DIR/rode”
...
[[ “$DISTRO” != “nixos” ]] && echo -e “Run ${GREEN}rode${NC} to start.”
