...
var ACTION_CATALOG = [
    { id: "rode.launcher", label: "Open Launcher", category: "Rode", dispatcher: "exec", argument: "rode run launcher", flags: "r" },
    { id: "rode.dashboard", label: "Open Dashboard", category: "Rode", dispatcher: "exec", argument: "rode run dashboard" },
    { id: "rode.assistant", label: "Open Assistant", category: "Rode", dispatcher: "exec", argument: "rode run assistant" },
    { id: "rode.clipboard", label: "Open Clipboard", category: "Rode", dispatcher: "exec", argument: "rode run clipboard" },
    { id: "rode.emoji", label: "Open Emoji", category: "Rode", dispatcher: "exec", argument: "rode run emoji" },
    { id: "rode.notes", label: "Open Notes", category: "Rode", dispatcher: "exec", argument: "rode run notes" },
    { id: "rode.tmux", label: "Open Tmux", category: "Rode", dispatcher: "exec", argument: "rode run tmux" },
    { id: "rode.wallpapers", label: "Open Wallpapers", category: "Rode", dispatcher: "exec", argument: "rode run wallpapers" },
    { id: "rode.config", label: "Open Settings", category: "Rode", dispatcher: "exec", argument: "rode run config" },
    { id: "rode.overview", label: "Open Overview", category: "Rode", dispatcher: "exec", argument: "rode run overview" },
    { id: "rode.powermenu", label: "Open Power Menu", category: "Rode", dispatcher: "exec", argument: "rode run powermenu" },
    { id: "rode.tools", label: "Open Tools", category: "Rode", dispatcher: "exec", argument: "rode run tools" },
    { id: "rode.screenshot", label: "Take Screenshot", category: "Rode", dispatcher: "exec", argument: "rode run screenshot" },
    { id: "rode.screenrecord", label: "Screen Record", category: "Rode", dispatcher: "exec", argument: "rode run screenrecord" },
    { id: "rode.lens", label: "Open Lens", category: "Rode", dispatcher: "exec", argument: "rode run lens" },
    { id: "rode.reload", label: "Reload Rode", category: "Rode", dispatcher: "exec", argument: "rode reload" },
    { id: "rode.quit", label: "Quit Rode", category: "Rode", dispatcher: "exec", argument: "rode quit" },
    ...
    { id: "brightness.up", label: "Brightness Up", category: "Brightness", dispatcher: "exec", argument: "rode brightness +5", flags: "le" },
    { id: "brightness.down", label: "Brightness Down", category: "Brightness", dispatcher: "exec", argument: "rode brightness -5", flags: "le" },
    ...
    { id: "system.dpms-off", label: "Display Off", category: "System", dispatcher: "exec", argument: "rodctl monitor set-dpms 0 0", flags: "l" },
    { id: "system.dpms-on", label: "Display On", category: "System", dispatcher: "exec", argument: "rodctl monitor set-dpms 0 1", flags: "l" },
...
function actionFromLegacy(dispatcher, argument, flags) {
    ...
    if (dispatcher === "exec") {
        ...
        if (arg.indexOf("rode brightness +5") === 0) return { id: "brightness.up", args: {} };
        if (arg.indexOf("rode brightness -5") === 0) return { id: "brightness.down", args: {} };
        ...
        if (arg === "rodctl monitor set-dpms 0 0") return { id: "system.dpms-off", args: {} };
        if (arg === "rodctl monitor set-dpms 0 1") return { id: "system.dpms-on", args: {} };
