...
Item {
    ...
    function _initMonitor() {
        ...
        var cmd = "rodctl system idle-monitor-create " + timeoutMs + " " + respect + " " + en;
    ...
    function _destroyMonitor() {
        if (_monitorId > 0) {
            var cmd = "rodctl system idle-monitor-destroy " + _monitorId;
    ...
    function _checkIdle() {
        ...
        var cmd = "rodctl system idle-monitor-get " + _monitorId;
    ...
    function _checkMediaInhibitor() {
        ...
        var cmd = "rodctl system media-inhibit-check";
    ...
    function _updateMonitor() {
        ...
        var cmd = "rodctl system idle-monitor-update " + _monitorId + " " + timeoutMs + " " + respect + " " + en;
