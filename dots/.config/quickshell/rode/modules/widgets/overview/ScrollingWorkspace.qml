    ...
    Item {
        ...
        Item {
            ...
            TapHandler {
                ...
                onDoubleTapped: {
                    RodctlService.dispatch(`workspace ${root.workspaceId}`);
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    // Timer to reset override position after RodctlService update
                    Timer {
                    ...
                    MouseArea {
                                ...
                                if (windowDelegate.dragging) {
                                    ...
                                    if (targetWs !== root.workspaceId) {
                                        ...
                                        if ((windowDelegate.windowData && windowDelegate.windowData.floating !== undefined ? windowDelegate.windowData.floating : false)) {
                                            ...
                                            RodctlService.dispatch(`movetoworkspacesilent ${targetWs}, address:${(windowDelegate.windowData && windowDelegate.windowData.address !== undefined ? windowDelegate.windowData.address : "")}`);
                                            RodctlService.dispatch(`movewindowpixel exact ${percentageX}% ${percentageY}%, address:${(windowDelegate.windowData && windowDelegate.windowData.address !== undefined ? windowDelegate.windowData.address : "")}`);
                        ...
                        onClicked: mouse => {
                            ...
                            if (mouse.button === Qt.LeftButton && !windowDelegate.dragging) {
                                RodctlService.dispatch(`focuswindow address:${windowDelegate.windowData.address}`);
                            } else if (mouse.button === Qt.MiddleButton) {
                                RodctlService.dispatch(`closewindow address:${windowDelegate.windowData.address}`);
                            }
                        }
